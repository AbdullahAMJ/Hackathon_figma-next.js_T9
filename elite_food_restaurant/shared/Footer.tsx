        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
          ...
          <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-2">
            <input 
              ...
              className="w-full sm:w-auto text-black py-2 px-3 sm:px-4 lg:px-6 rounded text-sm lg:text-base bg-yellow-500" 
            />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-[30px]">
          ...
          <div className="space-y-4 sm:space-y-6 col-span-1">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="bg-[#FF9F0D] flex-shrink-0 flex justify-center items-center w-12 sm:w-16 h-12 sm:h-16 ">
            ...
            <div className="space-y-3 sm:space-y-4">
              {['Keep Your Business', 'Grow Your Network', 'Maximize Your Potential'].map((title) => (
                <div key={title} className="flex items-center gap-3 sm:gap-4">
                  ...
                  />
                  <div>
                    <p className="text-gray-400 text-xs sm:text-sm">28 Feb 2022</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <span className="text-xs sm:text-sm text-gray-400">
              Copyright © 2024 by Abdullah. All Rights Reserved.
            </span>
